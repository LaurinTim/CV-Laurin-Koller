...
```latex
  ...
  % linkedin profile, first argument is entire link (has to contain https://), second argument is what will be displayed on the pdf
  \cvlinkedin{https://www.linkedin.com/in/profile-url}{www.linkedin.com/in/profile-url}
  % personal website
...
* Memberships
  ```latex
  \begin{membershps}[<separation>=1em]
